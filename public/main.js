...
var appRoutes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_13__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]] }
];
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.succ) {
                ...
                Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_1__["toast"])('Logged in!', 5000, 'green');
                _this.router.navigate(['/dashboard']);
            }
            else {
                Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_1__["toast"])('Incorrect login information', 5000, 'red');
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_1__["toast"])('You are now logged out', 5000, 'orange');
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateRegister(user)) {
            Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_1__["toast"])('Please fill out all fields', 5000, 'red');
            return false;
        }
        if (!this.validateService.validateEmail(user.email)) {
            Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_1__["toast"])('Please provide a valid email', 5000, 'red');
            return false;
        }
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.succ) {
                Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_1__["toast"])('You are now registered!', 5000, 'green');
                _this.router.navigate(['/login']);
            }
            else {
                Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_1__["toast"])('Failed to register', 5000, 'red');
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.http.post('http://localhost:3000/users/register', user, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) {
            return res.json();
        }));
    };
    AuthService.prototype.authenticateUser = function (user) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/authenticate', user, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) {
            return res.json();
        }));
    };
    AuthService.prototype.getProfile = function () {
        ...
        headers.append('Content-Type', 'application/json');
        return this.http.get('http://localhost:3000/users/profile', { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) {
            return res.json();
        }));
    };
...
module.exports = __webpack_require__(/*! /Users/zachdobbs/Documents/Projects/Blog/angular-src/src/main.ts */"./src/main.ts");
